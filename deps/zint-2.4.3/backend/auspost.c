...
const char *AusNTable[10] = {"00", "01", "02", "10", "11", "12", "20", "21", "22", "30"};

const char *AusCTable[64] = {"222", "300", "301", "302", "310", "311", "312", "320", "321", "322",
...
const char *AusBarTable[64] = {"000", "001", "002", "003", "010", "011", "012", "013", "020", "021",
...
void rs_error(char data_pattern[])
{
	...
	for(reader = 2; reader < (signed)strlen(data_pattern); reader += 3, triple_writer++) {
